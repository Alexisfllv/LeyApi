...
public class DocumentoController {
    ...
    @PostMapping
    public ResponseEntity<DocumentoDTOResponse> saveDocumento(@RequestBody DocumentoDTORequest request) {
        DocumentoDTOResponse documentodto = documentoService.saveDocumento(request);
        return ResponseEntity.status(HttpStatus.CREATED).body(documentodto);
    }

    @PutMapping("/{id}")
    public ResponseEntity<DocumentoDTOResponse> updateDocumento(@PathVariable Long id, @RequestBody DocumentoDTORequest request) {
        DocumentoDTOResponse documentoDTOResponse = documentoService.updateDocumento(request, id);
